...
/**
 * Created by dines on 2017-06-03.
 */
public class Attitude extends Fragment {
    ...
    private void initializeCardItemList(){
        ...
        String[] cardTitles = getResources().getStringArray(R.array.attitude_title);
        String[] cardContents = getResources().getStringArray(R.array.attitude_content);
